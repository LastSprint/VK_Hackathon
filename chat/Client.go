...
func (c *Client) writePump() {
	...
	for {
		...
		case message, ok := <-c.send:
			...
			if masg.Recipient != c.user.ID.Hex() {
				logrus.Warnln("NO USED MESSAGE")
				logrus.Warnln("RECIP " + masg.Recipient)
				logrus.Warnln("CLIENT " + c.user.ID.Hex())
				continue
			}
